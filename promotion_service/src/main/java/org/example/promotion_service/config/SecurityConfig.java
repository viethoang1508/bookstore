package org.example.promotion_service.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/public/promotions/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/public/promotions/apply").permitAll()
